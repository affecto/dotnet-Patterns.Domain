...
{
    /// <summary>
    /// Handler for executing domain events applied to an aggregate root or other domain entity instance. The handler uses the Unit of Work pattern.
    /// </summary>
    public interface IUnitOfWorkDomainEventHandler
    {
    }
    ...
    public interface IUnitOfWorkDomainEventHandler<in TEvent, in TUnitOfWork> : IUnitOfWorkDomainEventHandler
